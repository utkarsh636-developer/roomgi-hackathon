...
const DOCUMENT_TYPES = [
    { value: 'government_id', label: 'Government ID (Aadhar/PAN)' },
...
const VerificationPage = () => {
    ...
    const handleFileChange = (e) => {
        ...
        // Default new files to 'government_id' or first option, user can change later
        const newDocs = files.map(file => ({ file, type: 'government_id' }));
