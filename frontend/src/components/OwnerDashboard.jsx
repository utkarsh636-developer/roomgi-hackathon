...
import {
    LayoutDashboard, Plus, Home, MessageSquare, Star,
...
const OwnerDashboard = () => {
    ...
    React.useEffect(() => {
        const fetchData = async () => {
            try {
                // Fetch properties, user, enquiries, and reviews
                const [propsRes, userRes, enquiriesRes, reviewsRes] = await Promise.all([
