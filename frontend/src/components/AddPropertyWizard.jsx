...
const AddPropertyWizard = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 pt-24 pb-12 font-montserrat">
            <div className="max-w-3xl mx-auto px-4 sm:px-6">
                ...
                <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                    ...
                    <div className="bg-indigo-600 p-6 md:p-8 text-white">
                        ...
                        <p className="text-indigo-100 mt-2">Fill in the details to get your property verified and listed.</p>
                    </div>
                    ...
                    <div className="p-6 md:p-10">
                        ...
                        {step === 1 && (
                            <div className="space-y-6 animate-in slide-in-from-right-4 fade-in duration-300">
                                <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                                    <Home className="text-indigo-600" /> Basic Details
                                </h2>
                        ...
                        {step === 2 && (
                            <div className="space-y-8 animate-in slide-in-from-right-4 fade-in duration-300">
                                <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                                    <MapPin className="text-indigo-600" /> Location & Amenities
                                </h2>
                        ...
                        {step === 3 && (
                            <div className="space-y-8 animate-in slide-in-from-right-4 fade-in duration-300">
                                <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                                    <DollarSign className="text-indigo-600" /> Pricing & Photos
                                </h2>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            type="number"
                                            className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none text-xl font-bold text-gray-900"
                                            placeholder="12000"
                                ...
                                <div className="border-2 border-dashed border-gray-300 rounded-2xl p-8 text-center hover:border-indigo-400 hover:bg-indigo-50 transition-all cursor-pointer group">
                                    <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-white text-gray-400 group-hover:text-indigo-600 transition-colors">
                                        <Camera size={32} />
                                    </div>
                        ...
                        {step === 4 && (
                            <div className="space-y-8 animate-in slide-in-from-right-4 fade-in duration-300">
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none uppercase tracking-widest font-mono"
                                ...
                                <div className="flex items-start gap-3 mt-4">
                                    <div className={`mt-1 w-5 h-5 rounded border flex items-center justify-center cursor-pointer ${true ? 'bg-indigo-600 border-indigo-600 text-white' : 'border-gray-300'}`}>
                                        <Check size={14} />
                                    </div>
                        ...
                        <div className="flex justify-between pt-10 mt-6 border-t border-gray-100">
                            ...
                            <button
                                onClick={handleNext}
                                className="px-8 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-lg shadow-indigo-500/30 transition-all flex items-center gap-2"
                            >
